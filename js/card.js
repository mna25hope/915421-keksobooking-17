...
(function() {
  ...
  window.card = {
    show: function(pin) {
      ...
      cardCapacityElement.textContent = getHousingRoomsAndGuests(pin.offer.rooms, pin.offer.guests);

      var cardTimeElement = cardElement.querySelector(".popup__text--time");
      cardTimeElement.textContent = getHousingTimeinTimeout(pin.offer.checkin, pin.offer.checkout);
